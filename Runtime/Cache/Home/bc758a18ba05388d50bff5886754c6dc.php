...
<div class="content-wrapper">
    ...
    <script language="javascript">
      ...
      <div id="main_all" class="main_all" style="margin-top: 0px; background: #3d4247; padding-top: 52px;margin-bottom: -60px;">
      <div class="main" style="overflow: visible">
        <a id="faxian" name="faxian">
        </a>
        <div class="main_1" style="padding-bottom: 17px; margin-bottom: 50px">
          <span style="color: #fff">
            <?php echo C('WebNameSpell');?> DISCOVER｜<?php echo C('WebName');?>发现
          </span>
        ...
        <div style="text-align: center">
          <img alt="" src="<?php echo C('DOMAIN');?>/Public/Home/images/w1.jpg">
          <br>
          <div style="text-align: center; line-height: 46px; margin: 20px auto 0px; width: 297px; background: url(/Public/Home/images/w2.png) no-repeat; height: 46px; color: #fff; font-size: 14px">
            请使用微信扫描二维码以关注
          </div>
          <div style="text-align: center; margin: 20px 0px 40px 0px; color: #fff; font-size: 12px">
            微信号XINBON-TJ
          </div>
        </div>
      </div>
