   ...
   <script language="javascript">
    ...
    <script language="javascript">
      ...
      <div class="main">
        <div class="main_1">
          <span>
            Contact <?php echo C('WebNameSpell');?>｜联系<?php echo C('WebName');?>
          </span>
        </div>
        <div class="main_13">
          <div class="main_13_1">
            <img src="<?php echo C('DOMAIN');?>/Public/Home/images/contact_01.jpg" alt="">
          </div>
          <div class="main_13_2" style="    padding-bottom: 24px;
    border-bottom: 1px solid #706963;">
            <?php echo C('WebNameSpell'); echo C('WebName');?>作为最具革新精神与商业价值的品牌策略与商业设计公司，我们致力于成为您强势品牌可持续生长之助燃剂。
            <br>
            如果您希望进一步了解<?php echo C('WebNameSpell'); echo C('WebName');?>，欢迎联系我们。我们的品牌顾问或项目经理会在您的工作时间和您联系。
          </div>

          <div class="main_13_3">
            <?php echo C('WebNameSpell'); echo C('WebName');?>广告品牌策略与设计创新 直线（天津）<?php echo C('phone');?>
          </div>
          <div class="main_13_4">
            <?php echo C('address');?>
            <br>
            <?php echo C('WebUrl');?>
            <br>
            E-mail:<?php echo C('email');?>（设计咨询）
            <br>
            品牌设计咨询 <?php echo C('linkQQ');?>
            <br>
            &nbsp;
          </div>
          <div class="main_13_5">
            <span>
              <img src="<?php echo C('DOMAIN');?>/Public/Home/images/index_40.jpg" alt="">
            </span>
          </div>
        </div>
      </div>
